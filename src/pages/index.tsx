  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Navigate compliance with ease using ComplyMed - Your comprehensive solution for managing tasks, tracking progress, and ensuring legal compliance across different roles and organizations."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Navigate compliance with ease using ComplyMed - Your comprehensive solution for managing tasks, tracking progress, and ensuring legal compliance across different roles and organizations.`}
            </Text>
            <Box
